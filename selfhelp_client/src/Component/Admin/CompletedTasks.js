...
export class CompletedTasks extends PureComponent {
    ...
    componentDidMount(){
        console.log("ugiufgiugg")
        this.getData();
    }

    getData() {
        axios
            .get(`${API_URL}/task/getAllCompletedTask`)
            .then(res => {
    ...
    render() {
        return (
           ...
           <br/>  
<Container>
<h3 class="h3">Completed Task Details</h3>
                    ...
                    <thead>
                        ...
                        <th>Task</th>
                            ...
                            <th>Volunteer Phone number</th>
                                        ...
                                        <tbody>
                        {
                    this.state.tableData.slice(0).reverse().map((item)=>
                        <tr>
